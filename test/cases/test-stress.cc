...
struct ProtocolConfig {
	...
	friend std::ostream &operator<<(std::ostream &os, const ProtocolConfig &config)
	{
...
const ProtocolConfig protocols[] = {
	{"UDP", "bind [::]:61053", "server udp://127.0.0.1:60053", "bind [::]:60053"},
	{"TCP", "bind [::]:61053", "server tcp://127.0.0.1:60053", "bind-tcp [::]:60053"},
	{"TLS", "bind [::]:61053", "server tls://127.0.0.1:60053 -no-check-certificate", "bind-tls [::]:60053"},
	{"HTTP2", "bind [::]:61053", "server https://127.0.0.1:60053/dns-query -no-check-certificate -alpn h2",
	 "bind-https [::]:60053 -alpn h2"},
	{"HTTP1_1", "bind [::]:61053", "server https://127.0.0.1:60053/dns-query -no-check-certificate -alpn http/1.1",
...
speed-check-mode ping
	...
	for (int client_id = 0; client_id < num_clients; client_id++) {
		client_threads.emplace_back(
			[client_id, &total_queries, &success_count, &failure_count, &stop_all_tasks, queries_per_client]() {
...
INSTANTIATE_TEST_SUITE_P(, Stress, ::testing::ValuesIn(protocols),
						 [](const ::testing::TestParamInfo<ProtocolConfig> &info) { return info.param.name; });
